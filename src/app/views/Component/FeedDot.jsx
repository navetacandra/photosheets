            ...
            <div className="col-4 feed-info">
                <div className="dot3-feed">
                    <div className="dropdown">
                        <svg type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            {
                                isCreator ? (
                                    <>
                                        <span className="dropdown-item" data-bs-target={"#editPostModal" + props.id} data-bs-toggle="modal">Edit</span>
                                        <span className="dropdown-item text-danger" data-bs-target={"#deletePostModal" + props.id} data-bs-toggle="modal">Delete</span>
                                    </>
                                ) : (
                                    <>
